       ...
       <div className="w-[300px] h-[400px] shadow-2xl m-[6px] flex flex-col bg-primary p-[10px]">
         ...
         <h1 className="text-xl font-bold text-accent">{product.name}</h1>
         {
            ...
            <div className="flex gap-3 items-center">
               ...
               <p className="text-lg text-primary font-semibold">LKR {product.price.toFixed(2)}</p>
            </div> :
         ...
         <Link to={"/overview/" + product.productId} className="w-full h-[30p] border border-accent text-accent hover:bg-accent hover:text-white cursor-pointer mt-[5px]">View Product</Link>
